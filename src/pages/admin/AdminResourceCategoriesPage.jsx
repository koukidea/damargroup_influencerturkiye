...
function emptyForm() {
  return { label: '', description: '', icon: 'Newspaper', color: PALETTE[0].color, bg: PALETTE[0].bg }
}
      ...
      <div className="flex items-center justify-between gap-4 mb-8 flex-wrap">
        <div>
          ...
          <p className="text-gray-500">
            Yazıların gruplandığı kategorileri yönetin. Kategori adresi (slug) ilk
            oluşturmada belirlenir ve sonradan değişmez.
          </p>
        </div>
        <button
          onClick={startAdd}
                ...
                {resourceCategories.map((category) => {
                  ...
                  return (
                    <tr key={category.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-3 text-gray-400">/kaynaklar?kategori={category.slug}</td>
                      <td className="px-6 py-3">
